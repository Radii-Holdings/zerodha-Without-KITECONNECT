...
class KiteApp:
    ...
    INTERVAL_4M = '4minute'
    INTERVAL_5M = '5minute'
    INTERVAL_10M = '10minute'
    INTERVAL_30M = '30minute'
    INTERVAL_1HR = '60minute'
    INTERVAL_2HR = '2hour'
    INTERVAL_3HR = '3hour'
    INTERVAL_1D = 'day'
    ...
    def __init__(self, enctoken):
        ...
        self.oms_url = "https://kite.zerodha.com/oms"
    ...
    def historical_data(self, instrument_token, from_date, to_date, interval, continuous=False, oi=False, user=None):
        ...
        lst = self.session.get(
            f"{self.oms_url}/instruments/historical/{instrument_token}/{interval}?user_id={user}", params=params,
    ...
    def place_order(self, variety, exchange, tradingsymbol, transaction_type, quantity, product, order_type, price=None,
                    ...
                    trailing_stoploss=None, tag=None, user=None):
        params = locals()
        del params["self"]
    ...
    def modify_order(self, variety, order_id, parent_order_id=None, quantity=None, price=None, order_type=None,
                     trigger_price=None, validity=None, disclosed_quantity=None, user=None):
        params = locals()
        del params["self"]
        for k in list(params.keys()):
            if params[k] is None:
    ...
    def cancel_order(self, variety, order_id, parent_order_id=None, user=None):
